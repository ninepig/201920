 ...
 */
/**
 * Created by yangw on 2019/11/2.
 */
public class SequenceReconstraction444 {

    /**
     * 一个比较复杂的topo 排序的应用，关键是构造图比较难。
     * 关键是把每种可能，以及对应indegree写出来
     * 然后就是拓扑排序的过程。
     */
    public boolean sequenceReconstrction(int[] org , List<List<Integer>> seqs){
